      ...
      >
        ...
        <div className="intel-scroll">
          ...
          <DrawerSection
            ...
            loading={requestState !== "success" || loadStage < STAGES.price}
          >
            <p
          ...
          <DrawerSection
            ...
            loading={requestState !== "success" || loadStage < STAGES.gemini}
          >
          ...
          <DrawerSection
            ...
            loading={
              requestState !== "success" || loadStage < STAGES.technicals
            }
          >
          ...
          >
            ...
            >
              {String(
                gemini.news_reasoning || "No news-based reasoning available.",
              )}
            </p>
          </DrawerSection>

          <DrawerSection
            title="Market Ripple Effect 🌊"
            loading={requestState !== "success" || loadStage < STAGES.gemini}
          >
            <div
              style={{
          ...
          {showContradiction && (
            ...
            >
              ...
              >
                <p style={{ margin: 0, color: "#fdba74", fontWeight: 700 }}>
          ...
          <DrawerSection
            title="Fundamentals"
            loading={
              requestState !== "success" || loadStage < STAGES.fundamentals
            }
          >
            <div
              style={{
          ...
          <DrawerSection
            title="Events"
            loading={requestState !== "success" || loadStage < STAGES.events}
          >
            {hasEvents ? (
          ...
          >
            ...
            >
              <p style={{ margin: 0, color: "#e2e8f0", fontWeight: 700 }}>
                🔒 Institutional Flow — Coming Soon
              </p>
              <p
                style={{
                  margin: "0.35rem 0 0",
